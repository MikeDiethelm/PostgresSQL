-- ----------------------------------------------------------------------
-- DB Praktikum_11: L_T_P_LTP-Datenbank erzeugen und füllen
-- ----------------------------------------------------------------------

/*

DROP DATABASE IF EXISTS DB_Praktikum_11;
CREATE DATABASE DB_Praktikum_11;
...
-- Zusammenhang: Welcher Lieferant liefert welche Teile für welche Projekte
-- in welcher Menge
CREATE TABLE LTP (
